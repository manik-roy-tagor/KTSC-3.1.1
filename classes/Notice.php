...
class Notice{
	...
	public function getAllActiveNotice() {
		$query = "SELECT * FROM notice_tbl WHERE isActive = '1' ORDER BY id DESC LIMIT 30";
		$result = $this->db->select($query);
		return $result;
	}
	public function getAllActiveShortNotice() {
		$query = "SELECT * FROM notice_tbl WHERE isActive = '1' ORDER BY id DESC LIMIT 10";
		$result = $this->db->select($query);
		return $result;
	}
